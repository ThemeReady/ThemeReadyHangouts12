...
.method private constructor <init>(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)V
    ...
    invoke-direct {v0, p0}, Lfqb;-><init>(Lfqa;)V

    iput-object v0, p0, Lfqa;->c:Landroid/telecom/RemoteConference$Callback;

    .line 51
    iput-object p2, p0, Lfqa;->a:Landroid/telecom/RemoteConference;

    .line 52
    iput-object p3, p0, Lfqa;->b:Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;
    ...
    invoke-virtual {p0, v0}, Lfqa;->setConnectionCapabilities(I)V
    ...
    invoke-virtual {p0, v0}, Lfqa;->a(I)V

    .line 55
    iget-object v0, p0, Lfqa;->c:Landroid/telecom/RemoteConference$Callback;
    ...
    .line 57
    invoke-static {v0, p3}, Lfpu;->a(Landroid/telecom/RemoteConnection;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lfnz;
    ...
    .line 60
    invoke-virtual {p0, v2}, Lfqa;->addConnection(Landroid/telecom/Connection;)Z
...
.method public static a(Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lfqa;
    .locals 5
    ...
    .line 34
    invoke-static {v0, p1}, Lfpu;->a(Landroid/telecom/RemoteConnection;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lfnz;
    ...
    invoke-direct {v1, v0, p0, p1}, Lfqa;-><init>(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)V
...
.method a(I)V
    ...
    .line 139
    :pswitch_1
    invoke-virtual {p0}, Lfqa;->setOnHold()V

    goto :goto_0

    .line 142
    :pswitch_2
    invoke-virtual {p0}, Lfqa;->setActive()V
...
.method public onAudioStateChanged(Landroid/telecom/AudioState;)V
    ...
    .line 130
    iget-object v0, p0, Lfqa;->a:Landroid/telecom/RemoteConference;
...
.method public onSeparate(Landroid/telecom/Connection;)V
    ...
    .line 85
    iget-object v1, p0, Lfqa;->a:Landroid/telecom/RemoteConference;

    check-cast v0, Lfpu;

    invoke-virtual {v0}, Lfpu;->n()Landroid/telecom/RemoteConnection;

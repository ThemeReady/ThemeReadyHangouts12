...
# direct methods
.method constructor <init>(Lggc;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Licc;->a:Ljava/util/List;
...
.method public a(Lcom/google/android/gms/wearable/internal/PutDataResponse;)V
    ...
    invoke-direct {v0, v1, v2}, Lhyy;-><init>(Lcom/google/android/gms/common/api/Status;Lhzd;)V

    invoke-virtual {p0, v0}, Licc;->a(Ljava/lang/Object;)V

    iget v0, p1, Lcom/google/android/gms/wearable/internal/PutDataResponse;->b:I

    if-eqz v0, :cond_0

    iget-object v0, p0, Licc;->a:Ljava/util/List;

...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lfrz;)V
    .locals 0
    ...
    .line 89
    iput-object p1, p0, Lfry;->a:Landroid/content/Context;

    .line 90
    iput-object p2, p0, Lfry;->b:Lfrz;
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 98
    :try_start_0
    iget-object v1, p0, Lfry;->b:Lfrz;

    const/4 v2, 0x1

    invoke-interface {v0}, Lgdn;->b()Z

    move-result v0

    invoke-interface {v1, v2, v0}, Lfrz;->a(ZZ)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 104
    iput-object v4, p0, Lfry;->b:Lfrz;

    .line 105
    iget-object v0, p0, Lfry;->a:Landroid/content/Context;
    ...
    invoke-interface {v0, v1, v2}, Lfrz;->a(ZZ)V
    :try_end_1
    ...
    .line 105
    iget-object v1, p0, Lfry;->a:Landroid/content/Context;
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    invoke-interface {v0, v3, v3}, Lfrz;->a(ZZ)V

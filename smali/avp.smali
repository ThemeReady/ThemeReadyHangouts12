...
.field private static final d:Lavr;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lavp;->c:Ljava/util/Set;
    ...
    sput-object v0, Lavp;->e:Ljava/util/Set;

    .line 80
    invoke-static {v4}, Lazs;->a(I)Ljava/util/Queue;

    move-result-object v0

    sput-object v0, Lavp;->f:Ljava/util/Queue;

    return-void
.end method

.method public constructor <init>(Landroid/util/DisplayMetrics;Laqf;Laqa;)V
    .locals 1
    ...
    iput-object v0, p0, Lavp;->h:Landroid/util/DisplayMetrics;
...
.method private a(Ljava/io/InputStream;)I
    ...
    iget-object v2, p0, Lavp;->i:Laqa;

    invoke-direct {v1, p1, v2}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Laqa;)V
...
.method private a(Ljava/io/InputStream;Lamt;)Landroid/graphics/Bitmap$Config;
    .locals 4
...
.method private static a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lavr;)Landroid/graphics/Bitmap;
    .locals 9
    ...
    .line 5486
    invoke-static {p1}, Lavp;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
...
.method private static b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lavp;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method private b(Ljava/io/InputStream;)Z
    ...
    iget-object v1, p0, Lavp;->i:Laqa;

    invoke-direct {v0, p1, v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Laqa;)V
    ...
    .line 354
    sget-object v1, Lavp;->e:Ljava/util/Set;
...
.method private static declared-synchronized c()Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    sget-object v2, Lavp;->f:Ljava/util/Queue;
    ...
    .line 502
    :try_start_1
    sget-object v0, Lavp;->f:Ljava/util/Queue;
    ...
    .line 506
    invoke-static {v0}, Lavp;->d(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
.method private static c(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 513
    invoke-static {p0}, Lavp;->d(Landroid/graphics/BitmapFactory$Options;)V

    .line 514
    sget-object v1, Lavp;->f:Ljava/util/Queue;
...
# virtual methods
.method public a(Ljava/io/InputStream;IILanb;)Lapt;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public a(Ljava/io/InputStream;IILanb;Lavr;)Lapt;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2, v3}, Lgbi;->a(ZLjava/lang/String;)V

    .line 148
    move-object/from16 v0, p0

    iget-object v2, v0, Lavp;->i:Laqa;

    const/high16 v3, 0x10000

    const-class v4, [B

    invoke-virtual {v2, v3, v4}, Laqa;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    .line 149
    invoke-static {}, Lavp;->c()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 152
    sget-object v3, Lavp;->a:Lamy;

    move-object/from16 v0, p4

    invoke-virtual {v0, v3}, Lanb;->a(Lamy;)Ljava/lang/Object;
    ...
    .line 153
    sget-object v4, Lavp;->b:Lamy;

    move-object/from16 v0, p4

    invoke-virtual {v0, v4}, Lanb;->a(Lamy;)Ljava/lang/Object;
    ...
    invoke-static {v0, v10, v1}, Lavp;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lavr;)Landroid/graphics/Bitmap;
    ...
    .line 1175
    invoke-direct/range {p0 .. p1}, Lavp;->a(Ljava/io/InputStream;)I

    move-result v12

    .line 1176
    invoke-static {v12}, Lawc;->a(I)I
    ...
    invoke-direct {v0, v1, v3}, Lavp;->a(Ljava/io/InputStream;Lamt;)Landroid/graphics/Bitmap$Config;
    ...
    .line 2314
    :cond_2
    invoke-direct/range {p0 .. p1}, Lavp;->b(Ljava/io/InputStream;)Z
    ...
    .line 2316
    invoke-static {v10}, Lavp;->a(Landroid/graphics/BitmapFactory$Options;)Z
    ...
    .line 2494
    invoke-interface {v4, v6, v8, v3}, Laqf;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v0, Lavp;->g:Laqf;

    move-object/from16 v0, p5

    invoke-interface {v0, v3, v4}, Lavr;->a(Laqf;Landroid/graphics/Bitmap;)V
    ...
    .line 3445
    invoke-static {v4}, Lavp;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    .line 3447
    invoke-static {v10}, Lavp;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    iget-object v3, v0, Lavp;->h:Landroid/util/DisplayMetrics;
    ...
    invoke-static {v3, v4, v12}, Lawc;->a(Laqf;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Lavp;->g:Laqf;

    invoke-interface {v5, v4}, Laqf;->a(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v3, v4}, Lavb;->a(Landroid/graphics/Bitmap;Laqf;)Lavb;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 160
    invoke-static {v10}, Lavp;->c(Landroid/graphics/BitmapFactory$Options;)V

    .line 161
    move-object/from16 v0, p0

    iget-object v4, v0, Lavp;->i:Laqa;

    const-class v5, [B

    invoke-virtual {v4, v2, v5}, Laqa;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    :cond_8
    :try_start_1
    invoke-virtual {v4, v9, v7, v6, v8}, Lavh;->a(IIII)F
    ...
    :cond_b
    :try_start_2
    invoke-virtual {v4, v7, v9, v6, v8}, Lavh;->a(IIII)F
    ...
    sget-object v13, Lavp;->c:Ljava/util/Set;

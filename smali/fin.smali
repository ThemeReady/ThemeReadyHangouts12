...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lfin;->a:Ljava/util/concurrent/ExecutorService;
    ...
    sput-object v0, Lfin;->b:Ljava/lang/Runnable;
...
.method public static a()V
    ...
    .line 93
    :cond_0
    sget-object v0, Lfin;->a:Ljava/util/concurrent/ExecutorService;

    sget-object v1, Lfin;->b:Ljava/lang/Runnable;
...
.method private static a(I)V
    ...
    invoke-interface {v0, p0}, Lflf;->e(I)V
...
.method private static a(Landroid/database/sqlite/SQLiteDatabase;Ljava/util/List;)V
    ...
    .line 221
    invoke-static {p0}, Lbim;->d(Landroid/database/sqlite/SQLiteDatabase;)V

    .line 222
    invoke-static {v0}, Lfjc;->a(Landroid/content/Context;)V

    .line 224
    invoke-static {p0, p1}, Lbim;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/util/List;)V
    ...
    invoke-interface {v0}, Lflf;->h()I

    move-result v0

    invoke-static {v0}, Lfin;->a(I)V
...
.method private static a(Landroid/database/sqlite/SQLiteDatabase;Ljava/io/File;ILjava/util/List;)Z
    ...
    .line 248
    :try_start_0
    invoke-static {p0}, Lbim;->c(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 254
    invoke-static {v1}, Lfit;->a(Lorg/xmlpull/v1/XmlPullParser;)Lfit;
    ...
    invoke-direct {v3, p0}, Lfir;-><init>(Landroid/database/sqlite/SQLiteDatabase;)V

    invoke-virtual {v1, v3}, Lfit;->a(Lfiu;)Lfit;
    ...
    invoke-direct {v4, v3, p0}, Lfis;-><init>(Landroid/content/ContentValues;Landroid/database/sqlite/SQLiteDatabase;)V

    invoke-virtual {v1, v4}, Lfit;->a(Lfiv;)Lfit;

    .line 273
    invoke-virtual {v1}, Lfit;->a()V

    .line 275
    invoke-static {p0, p3}, Lbim;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/util/List;)V
    ...
    invoke-static {v1}, Lfjc;->a(Landroid/content/Context;)V

    .line 278
    invoke-static {p2}, Lfin;->a(I)V
    :try_end_1
...
.method public static a(Ljava/io/File;I)Z
    ...
    invoke-static {v0}, Lbim;->a(Landroid/content/Context;)Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v0

    .line 232
    invoke-static {v0}, Lbim;->a(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    ...
    invoke-static {v0, p0, v2, v1}, Lfin;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/io/File;ILjava/util/List;)Z
...
.method private static a(Ljava/lang/String;Ljava/io/File;)Z
    ...
    invoke-static {v3, v2, v6}, Lfwr;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_7
    ...
    invoke-static {v5, v6, v0}, Lfwr;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_a
...
.method static b()V
    ...
    invoke-static {v0, v4, v7}, Lgbi;->a(Landroid/content/Context;Ljava/lang/String;I)I
    ...
    .line 111
    invoke-interface {v0}, Lflf;->g()I

    move-result v0

    .line 112
    invoke-static {v1}, Lbim;->a(Landroid/content/Context;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 118
    invoke-static {v0, v2}, Lfin;->a(Ljava/lang/String;Ljava/io/File;)Z
    ...
    .line 121
    invoke-static {v6}, Lbim;->a(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;

    move-result-object v0

    .line 123
    invoke-static {v6, v2, v4, v0}, Lfin;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/io/File;ILjava/util/List;)Z
    ...
    .line 126
    invoke-static {v6, v0}, Lfin;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/util/List;)V

...
# virtual methods
.method public a(Lowg;Loye;)Ljava/net/URI;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 115
    invoke-virtual {p1}, Lowg;->a()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Loye;->b()Ljava/lang/String;
    ...
    .line 132
    invoke-static {v0}, Loyx;->b(Ljava/net/URI;)Ljava/net/URI;
...
.method public a(Ljava/net/URI;)Ljava/util/Map;
    ...
    .line 150
    :try_start_0
    iget-object v0, p0, Loyx;->c:Llpv;

    invoke-virtual {v0}, Llpv;->b()Ljava/util/Map;
    :try_end_0
...
.method public a(Loye;Lowf;Lowg;)Lowh;
    ...
    invoke-direct {v0, p0, v1, p3, p1}, Lowm;-><init>(Loyx;Lowh;Lowg;Loye;)V

...
# instance fields
.field private final c:Laqa;

.field private final d:Lavv;
...
.method public constructor <init>(Ljava/io/InputStream;Laqa;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laqa;

    .line 98
    new-instance v0, Lavw;

    invoke-direct {v0, p1}, Lavw;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lavv;

    .line 99
    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Laqa;)V
    .locals 1
...
.method private static a(Lavu;)I
    .locals 10
    ...
    .line 286
    invoke-virtual {p0, v1}, Lavu;->b(I)S
    ...
    .line 299
    :goto_0
    invoke-virtual {p0, v0}, Lavu;->a(Ljava/nio/ByteOrder;)V

    .line 301
    const/16 v0, 0xa

    invoke-virtual {p0, v0}, Lavu;->a(I)I
    ...
    .line 307
    invoke-virtual {p0, v3}, Lavu;->b(I)S
    ...
    invoke-virtual {p0, v5}, Lavu;->b(I)S
    ...
    invoke-virtual {p0, v6}, Lavu;->a(I)I
...
.method private d()I
    ...
    .line 244
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lavv;

    invoke-interface {v1}, Lavv;->b()S
    ...
    .line 267
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lavv;

    int-to-long v4, v1

    invoke-interface {v3, v4, v5}, Lavv;->a(J)J
...
.method public b()Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType;
    ...
    .line 114
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lavv;
    ...
    invoke-interface {v0, v2, v3}, Lavv;->a(J)J

    .line 127
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lavv;

    invoke-interface {v0}, Lavv;->c()I
    ...
    invoke-interface {v0, v6, v7}, Lavv;->a(J)J
...
.method public c()I
    ...
    .line 191
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laqa;

    const-class v3, [B

    invoke-virtual {v0, v2, v3}, Laqa;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v0, v2}, Lavv;->a([BI)I
    ...
    :cond_4
    :goto_2
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laqa;

    const-class v3, [B

    invoke-virtual {v2, v0, v3}, Laqa;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    invoke-direct {v1, v0, v2}, Lavu;-><init>([BI)V

    invoke-static {v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->a(Lavu;)I
    :try_end_1

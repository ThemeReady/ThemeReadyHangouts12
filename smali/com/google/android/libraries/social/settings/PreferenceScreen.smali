...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lkcv;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private a(Landroid/os/Bundle;)V
    ...
    .line 168
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/libraries/social/settings/PreferenceScreen;->B()Lkcz;

    move-result-object v0

    invoke-virtual {v0, v4}, Lkcz;->a(Landroid/content/DialogInterface;)V
...
.method protected a(Landroid/os/Parcelable;)V
    ...
    .line 218
    :cond_0
    invoke-super {p0, p1}, Lkcv;->a(Landroid/os/Parcelable;)V
    ...
    .line 223
    invoke-virtual {p1}, Lkdf;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Lkcv;->a(Landroid/os/Parcelable;)V

    .line 224
    iget-boolean v0, p1, Lkdf;->a:Z

    if-eqz v0, :cond_1

    .line 225
    iget-object v0, p1, Lkdf;->b:Landroid/os/Bundle;
...
.method protected e()Landroid/os/Parcelable;
    ...
    .prologue
    .line 202
    invoke-super {p0}, Lkcv;->e()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Lkdf;-><init>(Landroid/os/Parcelable;)V

    .line 209
    const/4 v1, 0x1

    iput-boolean v1, v0, Lkdf;->a:Z
    ...
    iput-object v1, v0, Lkdf;->b:Landroid/os/Bundle;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    invoke-virtual {v0, p1}, Lkcz;->b(Landroid/content/DialogInterface;)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 192
    invoke-virtual {v0, p0}, Lkcj;->a(Lcom/google/android/libraries/social/settings/PreferenceScreen;)V

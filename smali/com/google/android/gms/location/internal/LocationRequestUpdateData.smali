...
# static fields
.field public static final CREATOR:Lhia;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->CREATOR:Lhia;
...
.method public constructor <init>(IILcom/google/android/gms/location/internal/LocationRequestInternal;Landroid/os/IBinder;Landroid/app/PendingIntent;Landroid/os/IBinder;Landroid/os/IBinder;)V
    ...
    :goto_0
    iput-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->c:Lhio;
    ...
    :goto_1
    iput-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->e:Lhil;

    if-nez p7, :cond_4

    :goto_2
    iput-object v1, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->f:Lhhj;

    return-void

    :cond_0
    invoke-static {p4}, Lhip;->a(Landroid/os/IBinder;)Lhio;
    ...
    invoke-direct {v0, p6}, Lhin;-><init>(Landroid/os/IBinder;)V

    goto :goto_1

    .line 0
    :cond_4
    invoke-static {p7}, Lhhk;->a(Landroid/os/IBinder;)Lhhj;
...
.method b()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->c:Lhio;
    ...
    invoke-interface {v0}, Lhio;->asBinder()Landroid/os/IBinder;
...
.method c()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->e:Lhil;
    ...
    invoke-interface {v0}, Lhil;->asBinder()Landroid/os/IBinder;
...
.method d()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->f:Lhhj;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {p1, v1, v2, v3}, Lgbi;->a(Landroid/os/Parcel;ILandroid/os/IBinder;Z)V

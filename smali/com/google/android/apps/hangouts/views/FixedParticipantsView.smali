...
.method public a(Lbji;Ljava/util/List;)V
    .locals 12
    ...
    .line 87
    iget-object v1, v4, Ldpf;->a:Ldpl;

    .line 1170
    sget-object v2, Lfzn;->a:[I

    invoke-virtual {v1}, Ldpl;->ordinal()I
    ...
    .line 93
    :cond_2
    iget-object v1, v4, Ldpf;->h:Ljava/lang/String;

    if-eqz v1, :cond_7

    iget-object v1, v4, Ldpf;->f:Ljava/lang/String;

    if-nez v1, :cond_3

    iget-object v1, v4, Ldpf;->e:Ljava/lang/String;
    ...
    iget-object v2, v4, Ldpf;->h:Ljava/lang/String;

    const/4 v3, 0x0

    iget-object v4, v4, Ldpf;->f:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2, p1}, Lcom/google/android/apps/hangouts/views/AvatarView;->a(Ljava/lang/String;ZLbji;)V

    goto :goto_5

    .line 101
    :cond_8
    iget-object v1, v4, Ldpf;->b:Ldpj;

    invoke-virtual {v0, v1, p1}, Lcom/google/android/apps/hangouts/views/AvatarView;->a(Ldpj;Lbji;)V
    ...
    .line 127
    :cond_12
    invoke-static {v3, v8}, Lgbi;->a([Ljava/lang/String;I)Ljava/lang/CharSequence;

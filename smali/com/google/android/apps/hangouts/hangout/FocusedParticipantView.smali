...
.field private final e:Liuh;

.field private g:I

.field private final h:Lcsu;

.field private i:Lcug;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0}, Lcts;-><init>(Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;)V

    iput-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->e:Liuh;
    ...
    iput-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->h:Lcsu;
    ...
    iput-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->d:Ldbk;

    .line 115
    iget-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->d:Ldbk;

    if-eqz v0, :cond_0

    .line 116
    iget-object v2, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->d:Ldbk;
    ...
    .line 116
    invoke-interface {v2, p1, v0}, Ldbk;->a(Landroid/content/Context;Landroid/view/ViewGroup;)V

    .line 118
    iget-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->d:Ldbk;

    invoke-interface {v0, v3}, Ldbk;->b(I)V
...
.method private b(Lium;)V
    ...
    .line 213
    iget-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->k:Lcwo;

    .line 214
    iput-object p1, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->c:Lium;

    .line 215
    iget-object v1, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->c:Lium;
    ...
    invoke-virtual {v1}, Lcom/google/android/apps/hangouts/hangout/ParticipantTrayView;->e()Lcwo;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->k:Lcwo;

    .line 222
    :goto_0
    iget-object v1, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->h:Lcsu;
    ...
    iget-object v1, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->k:Lcwo;

    instance-of v1, v1, Lcxg;

    if-eqz v1, :cond_0

    .line 224
    iput-object v3, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->c:Lium;

    .line 225
    iput-object v3, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->k:Lcwo;
    ...
    iget-object v2, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->c:Lium;
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/apps/hangouts/hangout/ParticipantTrayView;->a(Ljava/lang/String;)Lcwo;
...
.method private c(I)V
    ...
    .line 289
    iget-object v1, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->d:Ldbk;
    ...
    invoke-interface {v1, v0}, Ldbk;->b(I)V
...
.method private f()V
    ...
    .prologue
    .line 145
    iget-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->a:Lcvn;

    invoke-virtual {p0}, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcvn;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method private g()V
    ...
    .prologue
    .line 198
    iget-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->i:Lcug;
...
.method public a(Lcug;)V
    ...
    .prologue
    .line 150
    iput-object p1, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->i:Lcug;

    .line 151
    invoke-direct {p0}, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->g()V

    .line 152
    iget-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->h:Lcsu;

    iget-object v1, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->e:Liuh;
    ...
    invoke-direct {v0, p0}, Lctt;-><init>(Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;)V
    ...
    invoke-direct {v0, p0}, Lctu;-><init>(Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;)V
...
.method a(Lcvn;Lcom/google/android/apps/hangouts/hangout/ParticipantTrayView;)V
    .locals 0
    ...
    .line 127
    iput-object p1, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->a:Lcvn;
...
.method public a(Lium;)V
    ...
    .line 372
    invoke-direct {p0, p1}, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->b(Lium;)V
...
.method public a(Ljava/lang/String;)V
    ...
    .prologue
    .line 243
    iget-object v0, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->c:Lium;
...
.method public b()V
    ...
    iget-object v2, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->k:Lcwo;
    ...
    invoke-virtual {v0}, Lcwo;->k()Landroid/graphics/Bitmap;
    ...
    invoke-interface {v0, v1}, Ldbk;->a(I)V
...
.method public c()V
    ...
    .line 1332
    invoke-virtual {v4}, Lcup;->T()Ljava/util/List;
    ...
    invoke-virtual {v5}, Lcxb;->b()Ljava/lang/String;

    move-result-object v8

    invoke-static {v7, v8}, Lfwx;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcup;->k()Lbji;

    move-result-object v3

    invoke-virtual {v3}, Lbji;->M()Z
    ...
    iget-object v3, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->c:Lium;

    invoke-virtual {v3}, Lium;->h()J
...
.method public y_()V
    ...
    .line 186
    iput-object v2, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->c:Lium;

    .line 187
    iput-object v2, p0, Lcom/google/android/apps/hangouts/hangout/FocusedParticipantView;->k:Lcwo;

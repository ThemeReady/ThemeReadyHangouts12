...
.method public constructor <init>()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->F:Lkja;

    invoke-direct {v0, p0, v1}, Ljiv;-><init>(Landroid/app/Activity;Lkhv;)V

    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->E:Lkeo;
    ...
    iput-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->n:Ljib;
    ...
    invoke-direct {v0, p0}, Lebc;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    invoke-direct {v0, p0}, Leay;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
...
.method private a(Landroid/net/Uri;ILajp;ZLjava/util/List;)Z
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2}, Laju;-><init>(I)V

    .line 564
    invoke-virtual {v1, p3}, Lajq;->a(Lajp;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lake; {:try_start_0 .. :try_end_0} :catch_4
    .catch Lakb; {:try_start_0 .. :try_end_0} :catch_6

    .line 567
    :try_start_1
    invoke-virtual {v1, v3}, Lajq;->a(Ljava/io/InputStream;)V
    :try_end_1
    .catch Lakf; {:try_start_1 .. :try_end_1} :catch_2
    ...
    .catch Lake; {:try_start_2 .. :try_end_2} :catch_4
    .catch Lakb; {:try_start_2 .. :try_end_2} :catch_6
    ...
    .catch Lake; {:try_start_3 .. :try_end_3} :catch_4
    .catch Lakb; {:try_start_3 .. :try_end_3} :catch_6
    ...
    invoke-direct {v1, p2}, Lajv;-><init>(I)V
    ...
    invoke-virtual {v1, v3}, Lajq;->a(Ljava/io/InputStream;)V
    :try_end_6
    .catch Lakf; {:try_start_6 .. :try_end_6} :catch_7
    ...
    .catch Lake; {:try_start_7 .. :try_end_7} :catch_4
    .catch Lakb; {:try_start_7 .. :try_end_7} :catch_6
    ...
    .catch Lake; {:try_start_8 .. :try_end_8} :catch_4
    .catch Lakb; {:try_start_8 .. :try_end_8} :catch_6
    ...
    .catch Lake; {:try_start_a .. :try_end_a} :catch_4
    .catch Lakb; {:try_start_a .. :try_end_a} :catch_6
    ...
    .catch Lake; {:try_start_b .. :try_end_b} :catch_4
    .catch Lakb; {:try_start_b .. :try_end_b} :catch_6
    ...
    invoke-direct {v1, v4}, Lakb;-><init>(Ljava/lang/String;)V
    ...
    .catch Lake; {:try_start_d .. :try_end_d} :catch_4
    .catch Lakb; {:try_start_d .. :try_end_d} :catch_6
...
.method public static synthetic a(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;ILajp;ZLjava/util/List;)Z
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->a(Landroid/net/Uri;ILajp;ZLjava/util/List;)Z
...
# virtual methods
.method public a(Lait;Ljava/util/List;Ljava/util/List;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 153
    invoke-virtual {p1}, Lait;->b()Ljava/lang/String;
    ...
    invoke-virtual {v1, v3, v0}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3618
    iget-object v0, p1, Lait;->a:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lajg;->b()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lajg;->d()Ljava/lang/String;
    ...
    invoke-virtual {v1, v5, v6}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v5, v0}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3622
    :cond_4
    iget-object v0, p1, Lait;->b:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laix;->d()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Laix;->b()Ljava/lang/String;
    ...
    .line 3626
    :cond_8
    iget-object v0, p1, Lait;->c:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laji;->h()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Laji;->j()Ljava/lang/String;
    ...
    .line 222
    invoke-virtual {v0}, Laji;->b()Ljava/lang/String;
    ...
    .line 226
    :cond_9
    invoke-virtual {v0}, Laji;->c()Ljava/lang/String;
    ...
    .line 234
    :cond_b
    invoke-virtual {v0}, Laji;->e()Ljava/lang/String;
    ...
    .line 238
    :cond_c
    invoke-virtual {v0}, Laji;->f()Ljava/lang/String;
    ...
    .line 242
    :cond_d
    invoke-virtual {v0}, Laji;->g()Ljava/lang/String;
    ...
    invoke-virtual {v1, v6, v5}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3634
    :cond_12
    iget-object v0, p1, Lait;->e:Ljava/util/List;
    ...
    .line 4630
    :cond_14
    iget-object v0, p1, Lait;->d:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lajf;->c()Ljava/lang/String;
    ...
    .line 294
    invoke-virtual {v0}, Lajf;->d()Ljava/lang/String;
    ...
    .line 295
    invoke-virtual {v5, v6, v1}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v5, v1, v0}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 4642
    :cond_17
    iget-object v0, p1, Lait;->f:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lajl;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2, v4, v0}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2, v0}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0, v2}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 6614
    :cond_1a
    iget-object v0, p1, Lait;->g:Ljava/util/List;
    ...
    .line 341
    invoke-virtual {v0}, Laje;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0, v4}, Lkb;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public a(Landroid/net/Uri;Lajx;)V
    .locals 6
    ...
    invoke-static {v0}, Lais;->a(Ljava/lang/String;)I
    ...
    invoke-direct {v3, v2, v1}, Lajm;-><init>(ILandroid/accounts/Account;)V
    ...
    invoke-direct {v0, p0, v1}, Lajo;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/os/Handler;)V

    invoke-virtual {v3, v0}, Lajm;->a(Lajo;)V
...
.method public c(I)Landroid/net/Uri;
    ...
    .line 446
    sget-object v0, Lcne;->bE:Ljava/util/Random;
    ...
    invoke-static {v3, v4, v0}, Lfwr;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v2, p0, v0}, Leba;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;)V
    ...
    .line 135
    :goto_1
    invoke-virtual {p0}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->f()Lss;

    move-result-object v0

    .line 136
    invoke-virtual {v0, v4}, Lss;->b(Z)V
    ...
    :cond_1
    :try_start_2
    invoke-virtual {p0}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->i()V
    :try_end_2
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->n:Ljib;
    ...
    invoke-direct {v0, p0}, Leaz;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    .line 7436
    invoke-virtual {v0, v1}, Leaz;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

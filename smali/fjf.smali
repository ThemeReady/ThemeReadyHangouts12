...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfjf;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sput-object v0, Lfjf;->c:Landroid/net/Uri;
    ...
    sput-object v0, Lfjf;->e:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public constructor <init>(Landroid/telephony/SmsManager;)V
    ...
    .line 48
    iput-object p1, p0, Lfjf;->d:Landroid/telephony/SmsManager;

    .line 49
    return-void
.end method

.method private static a([BLandroid/content/Context;)Lahv;
    .locals 4
    ...
    invoke-direct {v1, p0}, Lahp;-><init>([B)V
    ...
    .line 263
    invoke-static {p0, v0, p1}, Lfjr;->a([BLahf;Landroid/content/Context;)V
...
.method private a(Landroid/content/Context;Ljava/lang/String;)Lfjg;
    .locals 12

    .prologue
    .line 148
    sget-boolean v0, Lfjf;->a:Z
    ...
    invoke-direct {v4, v0}, Lfjg;-><init>(Landroid/net/Uri;)V

    .line 155
    sget-object v1, Lfjf;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 162
    :try_start_0
    sget-object v1, Lfjf;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 165
    sget-object v1, Lfjf;->c:Landroid/net/Uri;
    ...
    .line 168
    invoke-virtual {p0, p1, p2, v0, v2}, Lfjf;->a(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Landroid/content/Intent;)V
    ...
    :cond_3
    :try_start_4
    sget-object v0, Lfjf;->e:Ljava/util/concurrent/ConcurrentHashMap;
...
# virtual methods
.method public a(Landroid/content/Context;[BLjava/lang/String;)Lahv;
    .locals 6
    ...
    .line 95
    invoke-direct {p0, p1, p3}, Lfjf;->a(Landroid/content/Context;Ljava/lang/String;)Lfjg;
    ...
    .line 4271
    :pswitch_0
    iget-object v0, v0, Lfjg;->a:Landroid/net/Uri;

    .line 124
    invoke-virtual {p0, v0, p3, p1}, Lfjf;->a(Landroid/net/Uri;Ljava/lang/String;Landroid/content/Context;)Lahv;
    ...
    invoke-direct {v0, v1}, Lfjh;-><init>(I)V
    ...
    invoke-virtual {v0, p1, p2, p3, v2}, Lfjm;->a(Landroid/content/Context;[BLjava/lang/String;I)V
...
.method a(Landroid/net/Uri;Ljava/lang/String;Landroid/content/Context;)Lahv;
    .locals 8
    ...
    :try_start_0
    invoke-static {v0, v4}, Lgbi;->a(Ljava/io/File;Z)Ljava/nio/ByteBuffer;

    move-result-object v0

    .line 223
    invoke-static {v0}, Lgbi;->a(Ljava/nio/ByteBuffer;)[B
    :try_end_0
    ...
    .line 245
    :cond_1
    invoke-static {v0, p3}, Lfjf;->a([BLandroid/content/Context;)Lahv;
    ...
    .line 247
    invoke-static {v3, v0, v2}, Lfwr;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public a(JII)V
    ...
    .line 76
    :try_start_0
    invoke-virtual {v0, p3, p4}, Lfjg;->a(II)V
...
.method a(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Landroid/content/Intent;)V
    ...
    .line 210
    iget-object v0, p0, Lfjf;->d:Landroid/telephony/SmsManager;

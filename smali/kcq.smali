...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lkcq;->c:Landroid/os/Handler;

    .line 128
    new-instance v0, Lkcs;

    invoke-direct {v0, p0}, Lkcs;-><init>(Lkcq;)V

    iput-object v0, p0, Lkcq;->f:Ljava/lang/Runnable;

    .line 361
    new-instance v0, Lkct;

    invoke-direct {v0, p0}, Lkct;-><init>(Lkcq;)V

    iput-object v0, p0, Lkcq;->g:Landroid/view/View$OnKeyListener;
...
.method public a(Lcom/google/android/libraries/social/settings/PreferenceScreen;)V
    ...
    .line 244
    iget-object v0, p0, Lkcq;->d:Lkcz;

    invoke-virtual {v0, p1}, Lkcz;->a(Lcom/google/android/libraries/social/settings/PreferenceScreen;)Z
    ...
    .line 1320
    iget-object v0, p0, Lkcq;->c:Landroid/os/Handler;
...
.method public a(Lkcj;)Z
    .locals 1

    .prologue
    .line 291
    invoke-virtual {p1}, Lkcj;->k()Ljava/lang/String;
    ...
    .line 292
    invoke-virtual {p0}, Lkcq;->getActivity()Lcz;
...
.method public c()Lcom/google/android/libraries/social/settings/PreferenceScreen;
    ...
    invoke-virtual {v0}, Lkcz;->d()Lcom/google/android/libraries/social/settings/PreferenceScreen;
...
.method d()V
    ...
    .prologue
    .line 325
    invoke-virtual {p0}, Lkcq;->c()Lcom/google/android/libraries/social/settings/PreferenceScreen;
    ...
    .line 327
    invoke-virtual {p0}, Lkcq;->e()Landroid/widget/ListView;
...
.method public e()Landroid/widget/ListView;
    ...
    .prologue
    .line 1338
    iget-object v0, p0, Lkcq;->e:Landroid/widget/ListView;

    if-nez v0, :cond_3

    .line 1341
    invoke-virtual {p0}, Lkcq;->getView()Landroid/view/View;
    ...
    iput-object v0, p0, Lkcq;->e:Landroid/widget/ListView;
    ...
    iget-object v1, p0, Lkcq;->g:Landroid/view/View$OnKeyListener;
    ...
    iget-object v1, p0, Lkcq;->f:Ljava/lang/Runnable;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 167
    iget-boolean v0, p0, Lkcq;->a:Z

    if-eqz v0, :cond_0

    .line 168
    invoke-virtual {p0}, Lkcq;->d()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, v1, v2}, Lkcz;-><init>(Landroid/app/Activity;I)V

    iput-object v0, p0, Lkcq;->d:Lkcz;

    .line 153
    iget-object v0, p0, Lkcq;->d:Lkcz;

    invoke-virtual {v0, p0}, Lkcz;->a(Lkcq;)V
...
.method public onStart()V
    ...
    invoke-virtual {v0, p0}, Lkcz;->a(Lkdc;)V
...
.method public onStop()V
    ...
    invoke-virtual {v0, v1}, Lkcz;->a(Lkdc;)V

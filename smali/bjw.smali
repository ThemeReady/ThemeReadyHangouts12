...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbjw;->n:Ljava/util/Map;
...
.method public static a(Lbis;)Landroid/graphics/Bitmap;
    .locals 4

    .prologue
    .line 73
    sget-object v0, Lbjw;->n:Ljava/util/Map;
    ...
    .line 1091
    sget-object v0, Lbjx;->a:[I

    invoke-virtual {p0}, Lbis;->ordinal()I
    ...
    .line 1093
    invoke-static {v2, v0}, Lbjw;->a(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V

    move-object v0, v1

    .line 79
    :goto_0
    sget-object v1, Lbjw;->n:Ljava/util/Map;
...
.method public static a(Lbji;Ljava/util/List;Z)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 265
    iget-object v4, v0, Ldpf;->h:Ljava/lang/String;
    ...
    invoke-direct {v0, v4, v6}, Lfvk;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 279
    invoke-virtual {v0, v7}, Lfvk;->d(Z)Lfvk;

    move-result-object v0

    invoke-direct {v5, v0, v8, v7, v8}, Lbmh;-><init>(Lfvk;Lbmk;ZLjava/lang/Object;)V
    ...
    invoke-virtual {v0, v5}, Lfee;->c(Lfdi;)V
...
.method public static a(Landroid/graphics/Bitmap;)Z
    ...
    .line 298
    invoke-interface {v0, p0}, Lbns;->a(Landroid/graphics/Bitmap;)Z

    move-result v0

    if-nez v0, :cond_0

    sget-object v0, Lbjw;->f:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbjw;->g:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbjw;->h:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbjw;->i:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbjw;->j:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbjw;->k:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbjw;->l:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbjw;->m:Landroid/graphics/Bitmap;
...
.method public static b()Landroid/graphics/Bitmap;
    ...
    invoke-static {v0}, Lfvl;->a(I)Landroid/graphics/Bitmap;

    move-result-object v0

    sput-object v0, Lbjw;->f:Landroid/graphics/Bitmap;
...
.method public static c()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbjw;->g:Landroid/graphics/Bitmap;
...
.method public static d()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbjw;->h:Landroid/graphics/Bitmap;
...
.method public static e()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbjw;->i:Landroid/graphics/Bitmap;
...
.method public static f()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbjw;->j:Landroid/graphics/Bitmap;
...
.method public static g()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbjw;->k:Landroid/graphics/Bitmap;
...
.method public static h()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbjw;->l:Landroid/graphics/Bitmap;
...
.method public static i()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbjw;->m:Landroid/graphics/Bitmap;

...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lgfd;->c:Z

    sput-boolean v1, Lgfd;->d:Z
    ...
    sput-object v0, Lgfd;->a:Ljava/lang/Object;

    sput-object v2, Lgfd;->g:Ljava/lang/String;

    sput-object v2, Lgfd;->h:Ljava/lang/Integer;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lgfd;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lgfd;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1, v1}, Lgfd;->a(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-virtual {v1, v2, v0}, Lgfe;->a(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
...
.method public static a(Landroid/content/pm/PackageManager;)Z
    ...
    .prologue
    .line 0
    invoke-static {p0}, Lgfd;->b(Landroid/content/pm/PackageManager;)Z
    ...
    .line 9000
    sget-boolean v0, Lgfd;->c:Z

    if-eqz v0, :cond_1

    sget-boolean v0, Lgfd;->d:Z
...
.method public static b(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lgfd;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private static b(Landroid/content/pm/PackageManager;)Z
    ...
    .line 0
    sget-object v2, Lgfd;->a:Ljava/lang/Object;
    ...
    .line 8000
    sget-object v4, Lgfe;->a:Lgfe;

    .line 0
    const/4 v4, 0x1

    new-array v4, v4, [Lgll;

    const/4 v5, 0x0

    sget-object v6, Lgsw;->a:[Lgll;
    ...
    invoke-static {v3, v4}, Lgfe;->a(Landroid/content/pm/PackageInfo;[Lgll;)Lgll;
...
.method public static c(Landroid/content/Context;)I
    ...
    .line 1000
    sget-object v3, Lgfd;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v5, Lgfd;->a:Ljava/lang/Object;

    monitor-enter v5

    :try_start_1
    sget-object v3, Lgfd;->g:Ljava/lang/String;
    ...
    sput-object v3, Lgfd;->g:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    sput-object v3, Lgfd;->h:Ljava/lang/Integer;
    :try_end_2
    ...
    :goto_2
    :try_start_3
    sget-object v3, Lgfd;->h:Ljava/lang/Integer;
    ...
    sget-object v2, Lgfd;->g:Ljava/lang/String;
    ...
    .line 2000
    sget-object v5, Lgfe;->a:Lgfe;

    .line 0
    invoke-static {p0}, Lgbi;->T(Landroid/content/Context;)Z

    move-result v5

    if-eqz v5, :cond_8

    sget-object v5, Lgsw;->a:[Lgll;

    invoke-static {v3, v5}, Lgfe;->a(Landroid/content/pm/PackageInfo;[Lgll;)Lgll;
    ...
    invoke-static {v5, v6}, Lgfe;->a(Landroid/content/pm/PackageInfo;[Lgll;)Lgll;
    ...
    new-array v6, v6, [Lgll;

    const/4 v7, 0x0

    aput-object v5, v6, v7

    invoke-static {v3, v6}, Lgfe;->a(Landroid/content/pm/PackageInfo;[Lgll;)Lgll;
    :try_end_8
...
.method public static d(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, p0, v0, v2}, Lgey;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v2, v0, v3, v1}, Lgfa;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static e(Landroid/content/Context;)V
    ...
    sget-object v0, Lgfd;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

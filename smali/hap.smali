...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    iput-object v0, p0, Lhap;->b:Landroid/content/Context;

    iput-object p2, p0, Lhap;->c:Ljava/lang/Class;

    return-void
.end method

.method static declared-synchronized a(Landroid/content/Context;Ljava/lang/Class;)Lhap;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Lhap;-><init>(Landroid/content/Context;Ljava/lang/Class;)V
...
.method private a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lhap;->b:Landroid/content/Context;

    iget-object v1, p0, Lhap;->c:Ljava/lang/Class;
...
.method private b(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v0}, Lhap;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lhap;->b:Landroid/content/Context;
    ...
    invoke-static {v0}, Lgzy;->b(Landroid/os/Bundle;)V
...
.method private b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lhap;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lhap;->b:Landroid/content/Context;
    ...
    invoke-static {v3}, Lhap;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lhap;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method a(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1, v0}, Lhap;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v8, p0, Lhap;->b:Landroid/content/Context;
    ...
    .line 1000
    :goto_1
    invoke-direct {p0, p1}, Lhap;->b(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v0

    invoke-static {p1}, Lgzy;->c(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, v3, p1}, Lhap;->a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0, p1}, Lhap;->a(Landroid/content/Intent;Landroid/os/Bundle;)V

    iget-object v9, p0, Lhap;->b:Landroid/content/Context;
    ...
    iget-object v10, p0, Lhap;->b:Landroid/content/Context;

    invoke-direct {v9, v10}, Ley;-><init>(Landroid/content/Context;)V

    const/4 v10, 0x1

    invoke-virtual {v9, v10}, Ley;->e(Z)Ley;

    move-result-object v9

    invoke-virtual {v9, v5}, Ley;->a(I)Ley;
    ...
    invoke-virtual {v5, v6}, Ley;->a(Ljava/lang/CharSequence;)Ley;
    ...
    invoke-virtual {v5, v7}, Ley;->b(Ljava/lang/CharSequence;)Ley;
    ...
    invoke-virtual {v5, v6}, Ley;->e(I)Ley;

    :cond_1
    if-eqz v4, :cond_2

    invoke-virtual {v5, v4}, Ley;->a(Landroid/net/Uri;)Ley;

    :cond_2
    if-eqz v3, :cond_3

    invoke-virtual {v5, v3}, Ley;->a(Landroid/app/PendingIntent;)Ley;

    :cond_3
    if-eqz v0, :cond_4

    invoke-virtual {v5, v0}, Ley;->b(Landroid/app/PendingIntent;)Ley;

    :cond_4
    invoke-virtual {v5}, Ley;->b()Landroid/app/Notification;
    ...
    .line 1000
    :cond_c
    iget-object v6, p0, Lhap;->b:Landroid/content/Context;
    ...
    invoke-virtual {v5, v6}, Ley;->a(Ljava/lang/CharSequence;)Ley;
    :try_end_0
    .catch Lhaq; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0}, Lhaq;->getMessage()Ljava/lang/String;

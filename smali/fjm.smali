...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfjm;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sput-object v0, Lfjm;->c:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/telephony/SmsManager;)V
    ...
    iput-object v0, p0, Lfjm;->e:Ljava/util/concurrent/ConcurrentHashMap;

    .line 49
    iput-object p1, p0, Lfjm;->d:Landroid/telephony/SmsManager;

    .line 50
    return-void
.end method

.method private a(Landroid/content/Context;Ljava/lang/String;Lahf;Z)Lahw;
    .locals 14
    ...
    invoke-virtual {p0, p1, v0}, Lfjm;->a(Landroid/content/Context;Lahf;)Landroid/net/Uri;
    ...
    invoke-direct {v6, v2, v0}, Lfjn;-><init>(Landroid/net/Uri;Z)V

    .line 135
    sget-object v3, Lfjm;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 141
    :try_start_0
    iget-object v3, p0, Lfjm;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 144
    sget-object v3, Lfjm;->c:Landroid/net/Uri;
    ...
    invoke-virtual {p0, p1, v2, v0, v4}, Lfjm;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/content/Intent;)V

    .line 150
    const-class v2, Lbht;

    invoke-static {p1, v2}, Lkeo;->a(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v3, v4, v5}, Lbht;->a(Ljava/lang/String;J)J
    ...
    invoke-static {v2, v3, v7}, Lfwr;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_1
    :try_start_3
    iget-object v2, p0, Lfjm;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 5302
    :pswitch_0
    iget-object v2, v6, Lfjn;->a:Landroid/net/Uri;
    ...
    .line 6302
    iget-object v3, v6, Lfjn;->a:Landroid/net/Uri;
    ...
    .line 7302
    :cond_5
    iget-boolean v2, v6, Lfjn;->b:Z

    .line 2218
    if-eqz v2, :cond_6

    .line 8302
    iget-object v2, v6, Lfjn;->e:[B

    .line 2220
    invoke-virtual {p0, v2}, Lfjm;->a([B)Lahw;
    ...
    invoke-direct {v2, v3}, Lfjh;-><init>(I)V
...
# virtual methods
.method public a(Landroid/content/Context;Lahx;)Lahw;
    .locals 2
    ...
    invoke-direct {p0, p1, v0, p2, v1}, Lfjm;->a(Landroid/content/Context;Ljava/lang/String;Lahf;Z)Lahw;
...
.method a([B)Lahw;
    ...
    invoke-direct {v0, p1}, Lahp;-><init>([B)V
...
.method a(Landroid/content/Context;Lahf;)Landroid/net/Uri;
    .locals 6
    ...
    invoke-direct {v2, p1, p2}, Lahj;-><init>(Landroid/content/Context;Lahf;)V

    invoke-virtual {v2}, Lahj;->a()[B
    ...
    :goto_1
    invoke-static {v4, v2, v0}, Lfwr;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v2}, Lfjo;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3, v0}, Lfjh;-><init>(ILjava/lang/Throwable;)V
...
.method public a(JII[B)V
    ...
    .line 75
    iget-object v0, p0, Lfjm;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 78
    :try_start_0
    invoke-virtual {v0, p3, p4, p5}, Lfjn;->a(II[B)V
...
.method a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    .line 234
    iget-object v0, p0, Lfjm;->d:Landroid/telephony/SmsManager;

    .line 8436
    sget-object v4, Lfjc;->b:Landroid/os/Bundle;
...
.method public a(Landroid/content/Context;[BLjava/lang/String;I)V
    ...
    invoke-direct {v0, v1, p2, v2}, Lahf;-><init>(I[BI)V

    .line 115
    const/4 v1, 0x0

    invoke-direct {p0, p1, p3, v0, v1}, Lfjm;->a(Landroid/content/Context;Ljava/lang/String;Lahf;Z)Lahw;

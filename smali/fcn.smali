...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lfcn;->n:Z

    .line 52
    sput-boolean v1, Lfcn;->o:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lfcn;->p:Landroid/os/Handler;

    .line 61
    const-wide/32 v0, 0x493e0

    iput-wide v0, p0, Lfcn;->c:J

    .line 66
    const-wide/32 v0, 0x36ee80

    iput-wide v0, p0, Lfcn;->d:J

    .line 71
    const-wide/32 v0, 0x5265c00

    iput-wide v0, p0, Lfcn;->e:J

    .line 75
    iput-wide v2, p0, Lfcn;->q:J

    .line 81
    const-wide/32 v0, 0xa4cb800

    iput-wide v0, p0, Lfcn;->f:J
    ...
    .line 108
    iput-wide v2, p0, Lfcn;->m:J

    .line 276
    const/4 v0, 0x1

    iput-boolean v0, p0, Lfcn;->s:Z
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Lfcn;->a(Landroid/content/Context;Z)V
...
.method public static a(Landroid/content/Context;J)V
    ...
    invoke-direct {v1, p1, p2}, Lfdb;-><init>(J)V
...
.method private static a(Landroid/content/Context;Z)V
    ...
    invoke-static {p0, v0, v1}, Lgbi;->a(Landroid/content/Context;Ljava/lang/String;I)I
    ...
    .line 152
    invoke-static {p0, v2, v3}, Lfcn;->a(Landroid/content/Context;J)V
...
.method private a(Landroid/content/Context;Lbkj;)Z
    .locals 3
    ...
    .line 617
    invoke-direct {p0, p1}, Lfcn;->c(Landroid/content/Context;)Z
    ...
    .line 621
    :cond_0
    invoke-virtual {p2}, Lbkj;->l()Ljava/util/ArrayList;
    ...
    .line 622
    invoke-direct {p0, p1, p2, v0}, Lfcn;->a(Landroid/content/Context;Lbkj;Ljava/lang/String;)Z
...
.method private a(Landroid/content/Context;Lbkj;II)Z
    .locals 10
    ...
    invoke-virtual {p2, v0, p3}, Lbkj;->b(II)Ljava/util/List;
    ...
    :cond_3
    :try_start_3
    invoke-virtual {p2, v4, v5, p3}, Lbkj;->c(JI)Z
...
.method private a(Landroid/content/Context;Lbkj;Ljava/lang/String;)Z
    .locals 10
    ...
    invoke-virtual {p2, p3, v0}, Lbkj;->f(Ljava/lang/String;I)Ljava/util/List;
    ...
    .line 662
    invoke-virtual {p2, p3}, Lbkj;->P(Ljava/lang/String;)J
    ...
    :cond_3
    :try_start_3
    invoke-virtual {p2, p3, v4, v5}, Lbkj;->j(Ljava/lang/String;J)I

    move-result v0

    .line 700
    sget-boolean v1, Lfcn;->n:Z
...
.method private c(Landroid/content/Context;)Z
    ...
    iget-wide v6, p0, Lfcn;->t:J

    iget-wide v8, p0, Lfcn;->c:J
    ...
    .line 411
    invoke-static {p1, v2}, Lfcn;->a(Landroid/content/Context;Z)V
...
.method public declared-synchronized b(Landroid/content/Context;)Z
    ...
    invoke-direct {v6, p1, v0}, Lbkj;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v6, v8, v9}, Lbkj;->i(J)I

    move-result v0

    .line 1459
    sget-boolean v7, Lfcn;->n:Z
    ...
    .line 1479
    invoke-virtual {v6, v8, v9}, Lbkj;->h(J)I
    ...
    .line 1501
    invoke-virtual {v6, v8, v9}, Lbkj;->j(J)I
    ...
    .line 1523
    invoke-virtual {v6, v8, v9}, Lbkj;->k(J)I
    ...
    invoke-direct {p0, p1, v6, v0, v7}, Lfcn;->a(Landroid/content/Context;Lbkj;II)Z
    :try_end_9
    ...
    :cond_11
    :try_start_d
    invoke-direct {p0, p1, v6}, Lfcn;->a(Landroid/content/Context;Lbkj;)Z
    :try_end_d
    ...
    invoke-static {p1, v0}, Lbll;->a(Landroid/content/Context;I)Lbll;

    move-result-object v0

    .line 357
    invoke-virtual {v0}, Lbll;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {v8, v0}, Ldhv;->a(I)Ldhv;

    move-result-object v0

    const/4 v8, 0x3

    invoke-virtual {v0, v8}, Ldhv;->e(I)Ldhv;
...
.method c()V
    ...
    iput-wide v2, p0, Lfcn;->e:J

    .line 236
    const-string v1, "babel_gc_expired_invitation_slop"

    invoke-static {v0, v1, v6}, Lgbi;->a(Landroid/content/Context;Ljava/lang/String;I)I
    ...
    iput-wide v2, p0, Lfcn;->f:J

    .line 246
    const-string v1, "babel_gc_min_conversations_to_keep"

    invoke-static {v0, v1, v7}, Lgbi;->a(Landroid/content/Context;Ljava/lang/String;I)I
    ...
    invoke-static {v0, v1}, Lfcn;->a(Landroid/content/Context;Z)V

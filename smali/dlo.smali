...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Ldlo;->d:Ljava/util/concurrent/locks/ReadWriteLock;

    .line 3058
    iget-object v0, p0, Ldlo;->d:Ljava/util/concurrent/locks/ReadWriteLock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/ReadWriteLock;->readLock()Ljava/util/concurrent/locks/Lock;

    move-result-object v0

    iput-object v0, p0, Ldlo;->e:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, Ldlo;->f:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, Ldlo;->b:Ljava/util/Map;
    ...
    iput-object v0, p0, Ldlo;->c:Ljava/util/Map;
...
.method public a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, Ldlo;->a(Ljava/lang/String;Z)Ljava/lang/String;
...
.method a(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .prologue
    .line 3079
    iget-object v0, p0, Ldlo;->f:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->lock()V

    .line 3082
    :try_start_0
    iget-object v0, p0, Ldlo;->c:Ljava/util/Map;
    ...
    invoke-static {p1, v0, v1}, Lgbi;->a(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 3089
    iget-object v0, p0, Ldlo;->b:Ljava/util/Map;
    ...
    .line 3095
    invoke-static {v1}, Lgbi;->I(Ljava/lang/String;)V
    ...
    .line 3108
    iget-object v3, p0, Ldlo;->b:Ljava/util/Map;
    ...
    .catch Lfud; {:try_start_0 .. :try_end_0} :catch_3
    .catch Lfuc; {:try_start_0 .. :try_end_0} :catch_5
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_4
    .catch Lifb; {:try_start_0 .. :try_end_0} :catch_7
    .catch Lifa; {:try_start_0 .. :try_end_0} :catch_6
    ...
    .line 3140
    :cond_3
    iget-object v1, p0, Ldlo;->f:Ljava/util/concurrent/locks/Lock;
...
.method public b(Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, v1}, Lgbi;->a(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    :try_end_0
    .catch Lfuc; {:try_start_0 .. :try_end_0} :catch_0
    .catch Lifa; {:try_start_0 .. :try_end_0} :catch_6
    ...
    .catch Lfud; {:try_start_0 .. :try_end_0} :catch_5
...
.method public c(Ljava/lang/String;)Ljava/lang/Long;
    ...
    .prologue
    .line 2069
    iget-object v0, p0, Ldlo;->e:Ljava/util/concurrent/locks/Lock;
    ...
    .line 2073
    iget-object v1, p0, Ldlo;->e:Ljava/util/concurrent/locks/Lock;

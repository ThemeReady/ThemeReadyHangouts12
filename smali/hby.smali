...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Lhby;->d:Landroid/content/Context;

    new-instance v0, Lhcb;

    iget-object v2, p0, Lhby;->d:Landroid/content/Context;

    invoke-direct {v0, v2}, Lhcb;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lhby;->f:Lhcb;

    if-eqz p2, :cond_2

    invoke-direct {p0}, Lhby;->a()Ljavax/net/ssl/SSLSocketFactory;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Lhby;->c:Ljavax/net/ssl/SSLSocketFactory;

    iget-object v0, p0, Lhby;->c:Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 0
    iput-object v0, p0, Lhby;->e:Ljavax/net/ssl/HostnameVerifier;
...
.method private a()Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    iget-object v0, p0, Lhby;->d:Landroid/content/Context;

    invoke-static {v0}, Lgfb;->b(Landroid/content/Context;)Landroid/content/Context;
    ...
    iget-object v5, p0, Lhby;->d:Landroid/content/Context;
...
.method public a(Ljava/net/URL;Landroid/net/Network;)Ljava/net/HttpURLConnection;
    ...
    iget-object v0, p0, Lhby;->f:Lhcb;

    invoke-virtual {p1}, Ljava/net/URL;->toString()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lhcb;->a(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-direct {v1, v0}, Lavz;-><init>(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lhby;->c:Ljavax/net/ssl/SSLSocketFactory;

    invoke-virtual {v0, v2}, Ljavax/net/ssl/HttpsURLConnection;->setSSLSocketFactory(Ljavax/net/ssl/SSLSocketFactory;)V

    :cond_4
    iget-object v0, p0, Lhby;->e:Ljavax/net/ssl/HostnameVerifier;
    ...
    iget-object v2, p0, Lhby;->e:Ljavax/net/ssl/HostnameVerifier;
...
.method a(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, p1, p2}, Lhcb;->a(Ljava/lang/String;I)V

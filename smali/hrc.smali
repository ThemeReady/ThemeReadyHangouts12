...
# direct methods
.method constructor <init>(Lhqz;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .prologue
    .line 0
    invoke-direct {p0, p1, p2}, Lhrc;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2}, Lhrc;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Lhrc;->a:Lhqz;

    invoke-virtual {v2}, Lhqz;->s()Lhrr;
    ...
    invoke-virtual {v2, v3, p2, v0}, Lhrt;->a(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method public getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0}, Lhqz;->a(Lhqz;)Lhqr;

    move-result-object v0

    invoke-static {}, Lhqy;->G()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lhqr;->a(J)Z
    ...
    invoke-static {v0}, Lhqz;->b(Lhqz;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lhrc;->a:Lhqz;

    invoke-virtual {v1}, Lhqz;->m()Landroid/content/Context;
    ...
    invoke-static {v1}, Lhqz;->a(Lhqz;)Lhqr;

    move-result-object v1

    invoke-virtual {v1}, Lhqr;->b()V
    :try_end_1
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct/range {v0 .. v5}, Lhrc;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 2000
    sget-object v11, Lhqz;->a:Ljava/util/Map;
    ...
    .line 0
    invoke-direct/range {v6 .. v11}, Lhrc;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
